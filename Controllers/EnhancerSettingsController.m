...
@interface EnhancerSettingsController ()
@end

@implementation EnhancerSettingsController

- (void)loadView {
	[super loadView];

    self.title = @"Enhancer Options";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *CellIdentifier = @"EnhancerTableViewCell";
...
@implementation EnhancerSettingsController(Privates)
